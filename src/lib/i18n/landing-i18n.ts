...
const strings = {
  en: {
    ...
    heroAnimation: {
      ...
      detected3: "3 DETECTED",
      dataPipeline: "Data Pipeline",
      streaming: "STREAMING",
      mroEvents: "MRO Events Predicted",
      costReduction: "Cost Reduction",
      fleetUptime: "Fleet Uptime",
      tagline: "See what\u2019s breaking before it grounds your fleet",
      scanActive: "Fleet Asset Scan Active",
      scanMobile: "Fleet Asset Scan",
    },
    schedule: {
